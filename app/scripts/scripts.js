...
document.onreadystatechange = function () {
  if (document.readyState == "complete") {
    ...
    console.log('%c       ', 'font-size: 150px; background-image: url(https://d33wubrfki0l68.cloudfront.net/de105fd41bbdb1901c6c955b64de0a9b01371bab/9f078/assets/ngoc.jpg); background-size: contain; backround-repeat: no-repeat;');
    console.log("MANTUL");
